                    ...
                    <div class="ticket-position">
                        ...
                        <div class="ticket__inner">
                            ...
                            <div class="ticket-secondary">
                                ...
                                <span class="ticket__item">Cinema: <span class="ticket__cinema">{{ $order->timeShow->room->store->name }}</span></span>
                                <span class="ticket__item">Fast Food: <span class="ticket__hall">{{ $fastfood }}</span></span>
                                <span class="ticket__item ticket__price">price: <strong class="ticket__cost">{{ $order->final_price }}</strong></span>
                            </div>

                            <div class="ticket-primery">
                                <span class="ticket__item ticket__item--primery ticket__film">Film<br><strong class="ticket__movie">{{ $order->timeShow->film->title }}</strong></span>
                                <span class="ticket__item ticket__item--primery">Sits: <span class="ticket__place">{{ $sits }}</span></span>
                            </div>
