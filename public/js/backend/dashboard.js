...
$(document).ready(function () {
  ...
  $(add_button).click(function (e) {
    ...
    if (x < max_fields) {
      ...
      $(wrapper).append('' + '<div class="form-group">' + '<label for="name">Seats in row ' + x + ':</label>' + '<input type="number" class="form-control" name="row[]" value="" required="required">' + '<a href="#" class="remove_field"><i class="fa fa-minus"></i></a>' + '</div>'); //add input box
    }
  });
